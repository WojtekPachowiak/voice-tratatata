...
@app.command()
def main(
        to_say: str = typer.Argument(..., help="The text to be said."),
        output_path: Optional[str] = typer.Option(None, help="Path to the output file. If left empty, the output will be not be saved."),
        play_to_speakers: Optional[bool] = typer.Option(True, help="If True, the output will be played to speakers. If False, the output will not be played to speakers."),
    ...
    tratata.say(to_say, output_path = output_path, play_to_speakers = play_to_speakers)
